...
const DropdownUser = () => {
  ...
  return (
    <div className="relative  drop-shadow-1">
      <Link
        ref={trigger}
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-lg font-medium text-white dark:text-white capitalize">
        ...
        <svg
          className="hidden fill-admin-current sm:block"
          width="12"
          height="8"
          viewBox="0 0 12 8"
          fill="none"
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-admin-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <ul className="flex flex-col gap-5 border-b border-admin-stroke px-6 py-5 dark:border-admin-strokedark">
          <li>
            <Link
              href={`/${userData?.role}`}
            ...
            >
              ...
              {userValid ? "Go to dashboard" : "Become a host"}
            </Link>
          </li>
          <li>
            <Link
