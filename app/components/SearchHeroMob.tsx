...
const SearchHeroMob: React.FC<SearchHeroMobProps> = ({ isvisible, onClose }) => {
    ...
    <ThemeProvider theme={theme}>    
      <LocalizationProvider dateAdapter={AdapterDateFns}>      
        <div className="flex justify-center hero-searchbox-mod">          
          ...
          <button className="text-white text-xl search-modal-close font-extrabold flex" onClick={() => onClose()}><BsX className="text-3xl stroke-1"/></button>
        </div>
