...
const CarBookingCard: React.FC<ICar> = ({ price }) => {
  ...
  const handleCheckoutRide = () => {
    if (termsOfUse) {
      ...
      alert("You need to agree the terms of use.")
    }
  };
    ...
    <div className="grid-item w-full  bg-white rounded-lg shadow-md border border-gray-200 py-10 lg:px-10 md:px-10 px-7">
          ...
          <div className="flex flex-col justify-between w-full">
            <div className="flex flex-col mb-6">
              ...
              <TextField
                ...
                variant="outlined"
                value="J. P. Laurel Avenue (just fronting the Gaisano Mall), Bajada, Davao City, Davao Del Sur"
      ...
      <div className="grid grid-cols-2 gap-4 box-with-shadow w-full">
        <div className="flex items-center">
          <div className="ml-2">
            <p className="font">₱ {price} x {computedValue} day</p>
          </div>
        </div>
